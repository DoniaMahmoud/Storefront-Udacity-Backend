...
exports.login = exports.deletee = exports.edit = exports.show = exports.create = exports.index = void 0;
...
var create = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, uModel.create(req.body)];
            case 1:
                createdUser = _a.sent();
                res.send({
...
var show = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, uModel.show(req.params
                        .id)];
            case 1:
                user = _a.sent();
                res.send({
...
var edit = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, uModel.edit(req.body)];
            case 1:
                user = _a.sent();
                res.send({
...
var deletee = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, uModel.delete(req.params
                        .id)];
            case 1:
                user = _a.sent();
                res.send({
...
var login = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, uModel.login(req.body
                        .email, req.body
                        .password)];
            case 1:
                user = _a.sent();

...
exports.deletee = exports.edit = exports.show = exports.create = exports.index = void 0;
...
var index = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, opModel.index(req.params
                        .id)];
            case 1:
...
var create = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var createdOrderProduct, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, opModel.create(req.body)];
            case 1:
                createdOrderProduct = _a.sent();
                res.send({
                    message: 'Order Product is created successfully',
...
var show = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, opModel.show(req.params
                        .id)];
            case 1:
...
var edit = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, opModel.edit(req.body)];
            case 1:
                orderProduct = _a.sent();
                res.send({
                    message: 'Order Product is updated successfully',
...
var deletee = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, opModel.delete(req.body)];
            case 1:
                orderProduct = _a.sent();
                res.send({
                    message: 'Order Product is deleted successfully',
                    deletedOrderProduct: orderProduct,
                });
                return [3 /*break*/, 3];
            case 2:
                err_5 = _a.sent();

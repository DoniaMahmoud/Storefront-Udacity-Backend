...
var create = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var createdProduct, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, pModel.create(req.body)];
            case 1:
...
var show = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, pModel.show(req.params
                        .id)];
            case 1:
                product = _a.sent();
                res.send({
...
var edit = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, pModel.edit(req.body)];
            case 1:
                product = _a.sent();
                res.send({
...
var deletee = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, pModel.delete(req.params
                        .id)];
            case 1:
                product = _a.sent();
                res.send({

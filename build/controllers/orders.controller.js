...
exports.getOrderByUser = exports.deletee = exports.edit = exports.show = exports.create = exports.index = void 0;
...
var create = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var createdOrder, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, oModel.create(req.body)];
            case 1:
...
var show = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, oModel.show(req.params
                        .id)];
            case 1:
                order = _a.sent();
                res.send({
...
var edit = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, oModel.edit(req.body)];
            case 1:
                order = _a.sent();
                res.send({
...
var deletee = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, oModel.delete(req.params
                        .id)];
            case 1:
                order = _a.sent();
                res.send({
...
var getOrderByUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, oModel.getOrderByUser(req.params
                        .id)];
            case 1:
                order = _a.sent();
                res.send({
